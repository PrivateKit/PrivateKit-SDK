...
export default class LocationServices {
  ...
  static checkLocationPermission() {
    ...
    .then(result => {
      if (RESULTS.UNAVAILABLE || locationPermission == RESULTS.BLOCKED) {
        return false;
      }
      return true;
    })
  ...
  static start() {
    ...
    BackgroundGeolocation.configure({
      ...
      notificationText: "Your App is securely storing your GPS coordinates once every five minutes on this device.",
  ...
  static stop() {
    ...
    PushNotification.localNotification({
      title: "Location Tracking Was Disabled",
      message: "PrivateKit is securely storing your GPS coordinates once every five minutes on this device.",
    });
